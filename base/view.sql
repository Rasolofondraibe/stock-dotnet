...
(SELECT SUM(m1.prixunitaire*m1.quantiteentree)/SUM(m1.quantiteentree) FROM mouvement m1 WHERE m1.date<=m.date AND m1.idarticle = m.idarticle AND m1.idmagasin = m.idmagasin) as moyenneprixunitaire,
